/*
	the primary problem .. partial correct do again.. 
	exterme optimisation..
*/
...
void sieve(){
	...
	isprime[1]=0;
	isprime[2]=1;
	for(int i=4 ; i<N+1 ; i+=2) isprime[i]=0;
...
int32_t main(){	
	...
	{	
		if(n <=3){
			...
			p2=0;
			goldbach(n);
			if(p1==0 and p2==0) cout << "NO WAY!" << endl;
			else cout << n <<":" << endl << p1 <<"+" << p2 << endl;
		}
	}
	return 0;
}
